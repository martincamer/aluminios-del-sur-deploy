      ...
      >
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3 w-full">
            {errors.color && (
              <span className="bg-red-500 text-sm text-white rounded-lg p-3 text-center uppercase">
                El color para editar es requerido
              </span>
            )}
            <label className="font-semibold text-normal text-white">
              Color:
            ...
            >
              ...
              <option value={"blanco brillante - insertos"}>
                blanco brillante - insertos
              </option>
              <option value={"blanco ibera"}>blanco ibera</option>
              <option value={"blanco ibera - insertos"}>
                blanco ibera - inserto
              </option>
              <option value={"negro"}>negro</option>
              <option value={"negro - insertos"}>negro - insertos</option>
